// Generated from Graphql.g4 by ANTLR 4.3
...
public class GraphqlParser extends Parser {
	...
	public static final int
		...
		BooleanValue=17, NAME=18, IntValue=19, FloatValue=20, Sign=21, IntegerPart=22, 
		NonZeroDigit=23, ExponentPart=24, Digit=25, StringValue=26, Ignored=27;
	public static final String[] tokenNames = {
		"<INVALID>", "'mutation'", "'...'", "'fragment'", "':'", "'['", "'{'", 
		"'on'", "']'", "'}'", "'='", "'@'", "'!'", "'$'", "'('", "')'", "'query'", 
		"BooleanValue", "NAME", "IntValue", "FloatValue", "'-'", "IntegerPart", 
	...
	public final DocumentContext document() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(68); definition();
				}
				}
				setState(71); 
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__15) | (1L << T__13) | (1L << T__10) | (1L << T__0))) != 0) );
			}
		}
	...
	public final DefinitionContext definition() throws RecognitionException {
		...
		try {
			...
			case T__0:
				enterOuterAlt(_localctx, 1);
				{
				setState(73); operationDefinition();
				}
				break;
			case T__13:
				enterOuterAlt(_localctx, 2);
				{
				setState(74); fragmentDefinition();
				}
				break;
			default:
	...
	public final OperationDefinitionContext operationDefinition() throws RecognitionException {
		...
		try {
			...
			case T__0:
				...
				if (_la==T__2) {
					{
					setState(82); variableDefinitions();
					}
				}
				...
				if (_la==T__5) {
					{
					setState(85); directives();
					}
				}

				setState(88); selectionSet();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final VariableDefinitionsContext variableDefinitions() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(95); variableDefinition();
				}
				}
				setState(98); 
				_errHandler.sync(this);
	...
	public final ArgumentContext argument() throws RecognitionException {
		...
		try {
			...
			setState(153); valueWithVariable();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FragmentSpreadContext fragmentSpread() throws RecognitionException {
		...
		try {
			...
			setState(156); fragmentName();
			setState(158);
			_la = _input.LA(1);
			if (_la==T__5) {
				{
				setState(157); directives();
				}
			}
	...
	public final InlineFragmentContext inlineFragment() throws RecognitionException {
		...
		try {
			...
			setState(162); typeCondition();
			setState(164);
			_la = _input.LA(1);
			if (_la==T__5) {
				{
				setState(163); directives();
				}
			}

			setState(166); selectionSet();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FragmentDefinitionContext fragmentDefinition() throws RecognitionException {
		...
		try {
			...
			setState(169); fragmentName();
			setState(170); match(T__9);
			setState(171); typeCondition();
			setState(173);
			_la = _input.LA(1);
			if (_la==T__5) {
				{
				setState(172); directives();
				}
			}

			setState(175); selectionSet();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ValueContext value() throws RecognitionException {
		...
		try {
			...
			case IntValue:
				enterOuterAlt(_localctx, 1);
				{
				setState(181); match(IntValue);
				}
				break;
			case FloatValue:
				enterOuterAlt(_localctx, 2);
				{
				setState(182); match(FloatValue);
				}
				break;
			case StringValue:
				enterOuterAlt(_localctx, 3);
				{
				setState(183); match(StringValue);
				}
				break;
			case BooleanValue:
				enterOuterAlt(_localctx, 4);
				{
				setState(184); match(BooleanValue);
				}
				break;
			case NAME:
				enterOuterAlt(_localctx, 5);
				{
				setState(185); enumValue();
				}
				break;
			case T__11:
				enterOuterAlt(_localctx, 6);
				{
				setState(186); arrayValue();
				}
				break;
			case T__10:
				enterOuterAlt(_localctx, 7);
				{
				setState(187); objectValue();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ValueWithVariableContext valueWithVariable() throws RecognitionException {
		...
		try {
			...
			case IntValue:
				enterOuterAlt(_localctx, 2);
				{
				setState(191); match(IntValue);
				}
				break;
			case FloatValue:
				enterOuterAlt(_localctx, 3);
				{
				setState(192); match(FloatValue);
				}
				break;
			case StringValue:
				enterOuterAlt(_localctx, 4);
				{
				setState(193); match(StringValue);
				}
				break;
			case BooleanValue:
				enterOuterAlt(_localctx, 5);
			...
			case NAME:
				enterOuterAlt(_localctx, 6);
				{
				setState(195); enumValue();
				}
				break;
			case T__11:
				enterOuterAlt(_localctx, 7);
				{
				setState(196); arrayValueWithVariable();
				}
				break;
			case T__10:
				enterOuterAlt(_localctx, 8);
				{
				setState(197); objectValueWithVariable();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final