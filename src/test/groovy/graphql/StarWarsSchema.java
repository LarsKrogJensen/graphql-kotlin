...
public class StarWarsSchema {
    ...
    public static GraphQLObjectType humanType = Companion.newObject()
                                                         .name("Human")
    ...
    public static GraphQLObjectType droidType = Companion.newObject()
                                                         .name("Droid")
    ...
    public static GraphQLObjectType queryType = Companion.newObject()
                                                         .name("QueryType")
                                                         .field(Companion.newFieldDefinition()
                                                                         .name("hero")
