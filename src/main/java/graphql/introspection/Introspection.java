...
public class Introspection {
    ...
    public static GraphQLObjectType __Field = newObject()
            ...
            .field(newFieldDefinition()
                    .name("description")
                    .type(GraphQLString))
            .field(GraphQLFieldDefinition.<List<GraphQLArgument>>newFieldDefinition()
                    .name("args")
                    .type(new GraphQLNonNull(new GraphQLList(new GraphQLNonNull(__InputValue))))
                    .dataFetcher(environment -> {
                        CompletableFuture<List<GraphQLArgument>> promise = new CompletableFuture<>();
                        GraphQLFieldDefinition<?> type = (GraphQLFieldDefinition<?>) environment.getSource();
            ...
            .field(newFieldDefinition()
                    .name("type")
                    .type(new GraphQLNonNull(new GraphQLTypeReference("__Type"))))
            .field(GraphQLFieldDefinition.<Boolean>newFieldDefinition()
                    .name("isDeprecated")
    ...
    public static GraphQLObjectType __Type = newObject()
            .name("__Type")
            .field(GraphQLFieldDefinition.<TypeKind>newFieldDefinition()
                    .name("kind")
            ...
            .field(newFieldDefinition()
                    .name("description")
                    .type(GraphQLString))
            .field(GraphQLFieldDefinition.<List<GraphQLFieldDefinition>>newFieldDefinition()
                    .name("fields")
            ...
            .field(GraphQLFieldDefinition.<List<GraphQLInterfaceType>>newFieldDefinition()
                    .name("interfaces")
                    .type(new GraphQLList(new GraphQLNonNull(new GraphQLTypeReference("__Type"))))
                    .dataFetcher(interfacesFetcher))
            .field(GraphQLFieldDefinition.<List<GraphQLObjectType>>newFieldDefinition()
                    .name("possibleTypes")
                    .type(new GraphQLList(new GraphQLNonNull(new GraphQLTypeReference("__Type"))))
                    .dataFetcher(possibleTypesFetcher))
            .field(GraphQLFieldDefinition.<List<GraphQLEnumValueDefinition>>newFieldDefinition()
                    .name("enumValues")
            ...
            .field(GraphQLFieldDefinition.<List<GraphQLInputObjectField>>newFieldDefinition()
                    .name("inputFields")
                    .type(new GraphQLList(new GraphQLNonNull(__InputValue)))
                    .dataFetcher(inputFieldsFetcher))
            .field(GraphQLFieldDefinition.<GraphQLType>newFieldDefinition()
                    .name("ofType")
    ...
    public static GraphQLFieldDefinition<GraphQLSchema> SchemaMetaFieldDef =
            GraphQLFieldDefinition.<GraphQLSchema>newFieldDefinition()
                    .name("__schema")
    ...
    public static GraphQLFieldDefinition<GraphQLType> TypeMetaFieldDef =
            GraphQLFieldDefinition.<GraphQLType>newFieldDefinition()
                    .name("__type")
                    .type(__Type)
    ...
    public static GraphQLFieldDefinition<String> TypeNameMetaFieldDef =
            GraphQLFieldDefinition.<String>newFieldDefinition()
                    .name("__typename")
                    .type(new GraphQLNonNull(GraphQLString))
